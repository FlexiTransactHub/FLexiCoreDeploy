...
{
    public class PosTerminalSalesController : Controller
    {
        private readonly IBranchService _branchService;
        private readonly IProductService _productService;
        private readonly ISaleService _saleService;

        public PosTerminalSalesController(
        ...
        public async Task<IActionResult> Create(int branchId)
        {
            ...
            ViewData["Employees"] = await _branchService.GetEmployeesByBranchId(branchId);
            ...
            return View("~/Views/Terminal/Pos/Create.cshtml", model);
        }
        ...
        public async Task<IActionResult> Create(Sale model, List<int> productIds, List<int> serviceIds, List<int> quantities, List<decimal> unitPrices)
        {
            ...
            ViewData["Employees"] = await _branchService.GetEmployeesByBranchId(model.BranchId);
