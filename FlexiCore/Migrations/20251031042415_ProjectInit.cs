...
namespace FlexiCore.Migrations
{
    ...
    public partial class ProjectInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BusinessTypeConfigurations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessTypeConfigurations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaystackKey = table.Column<string>(type: "text", nullable: false),
                    CryptoWalletAddress = table.Column<string>(type: "text", nullable: false),
                    NairaEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    CryptoEnabled = table.Column<bool>(type: "boolean", nullable: false),
